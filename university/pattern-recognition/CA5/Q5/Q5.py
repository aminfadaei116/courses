...
svr = svm.SVC(kernel='poly',decision_function_shape='ovo')
...
parameters = { 'C':np.linspace(1, 10, 10) }
svr = svm.SVC(kernel='poly',decision_function_shape='ovr')
clf = GridSearchCV(svr, parameters)
clf.fit(Train_data, Train_label)
print("training time: ", time()-t1," s")
t1 = time()
test_result = clf.predict(Test_data)
print("testing time: ", time()-t1," s")
...
t1 = time()
parameters = { 'C':np.linspace(1, 10, 10) }
svr = LinearSVC(multi_class='crammer_singer')
clf = GridSearchCV(svr, parameters)
clf.fit(Train_data, Train_label)
print("training time: ", time()-t1," s")
t1 = time()
